    ...
    <div style={{display:'flex',flexDirection:'column',minHeight:'100vh',background:'var(--bg-primary)',fontFamily:"'Inter',sans-serif"}}>
      <style>{`
        ...
        @media(max-width:768px){
          .a-sidebar{position:fixed;left:0;top:0;width:240px;height:100vh;z-index:60;transform:translateX(-100%);transition:transform .28s cubic-bezier(.16,1,.3,1);box-shadow:4px 0 32px rgba(0,30,80,.18);overflow:hidden}
          .a-sidebar.mobile-open{transform:translateX(0)}
          .a-main{padding:1rem 1rem 5rem;width:100%}
      ...
      <div className="mobile-top-bar">
        ...
        <div style={{width:36,height:36,borderRadius:'50%',background:'linear-gradient(135deg,#003580,#1a4fa0)',display:'flex',alignItems:'center',justifyContent:'center',fontSize:'.85rem',fontWeight:700,color:'white',cursor:'pointer'}} onClick={() => window.dispatchEvent(new CustomEvent('open-profile-panel'))}>U</div>
      </div>
